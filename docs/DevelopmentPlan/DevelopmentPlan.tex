...
No confidential information is being used in this project.
...
TODO
This is our idea but we want to make this open source so what do we put here?
...
Team Liason - Ayush
Note taker - Andrew
Meeting chair - Andrew

Reviewer of code: all
Reviewer of documentation: all
...
all PR's must have a description - we will create a template for PR's
Main branch should be protected - no direct commits to main, all changes must be made through PR's
PR's must be reviewed by at least one other team member before being merged
PR's must have a passing CI build before being merged
- this will include unit tests, linting, and code coverage checks

We will create milestones for each major deadline - e.g. Problem Statement, Requirements doc, POC etc.
We will use the provided templates for TA, supervisor and team meetings.
...
TODO - everything below needs to be decided as a team
